...
const Menu = ({ navigation }) => { 
  ...
  const menuItems = [
    ...
    { id: '2', title: 'Driver Registration', icon: 'car', type: 'FontAwesome', route: 'DriverRegistration' },
    ...
    { id: '7', title: 'Set up driving or delivering', icon: 'work', type: 'MaterialIcons', route: 'SetUpDrivingDelivering' },
    { id: '8', title: 'Manage Account', icon: 'user', type: 'FontAwesome', route: 'Profile' },
